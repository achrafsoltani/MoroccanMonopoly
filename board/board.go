...
func NewBoard() *Board {
	...
	b.Spaces[1] = Space{Index: 1, Name: "Derb Sultan", Type: SpaceProperty, Group: GroupBrown,
		Price: 60, Rent: [6]int{2, 10, 30, 90, 160, 250}, HouseCost: 50}
	b.Spaces[2] = Space{Index: 2, Name: "Caisse Commune", Type: SpaceCommunityChest}
	b.Spaces[3] = Space{Index: 3, Name: "Bab Marrakech", Type: SpaceProperty, Group: GroupBrown,
		Price: 60, Rent: [6]int{4, 20, 60, 180, 320, 450}, HouseCost: 50}
	b.Spaces[4] = Space{Index: 4, Name: "Impot sur le Revenu", Type: SpaceTax, TaxAmount: config.IncomeTax}
	b.Spaces[5] = Space{Index: 5, Name: "Gare Casa-Voyageurs", Type: SpaceRailroad, Price: 200}
	b.Spaces[6] = Space{Index: 6, Name: "Av. Hassan II", Type: SpaceProperty, Group: GroupLightBlue,
		Price: 100, Rent: [6]int{6, 30, 90, 270, 400, 550}, HouseCost: 50}
	b.Spaces[7] = Space{Index: 7, Name: "Chance", Type: SpaceChance}
	b.Spaces[8] = Space{Index: 8, Name: "Bab Bou Jeloud", Type: SpaceProperty, Group: GroupLightBlue,
		Price: 100, Rent: [6]int{6, 30, 90, 270, 400, 550}, HouseCost: 50}
	b.Spaces[9] = Space{Index: 9, Name: "Talaa Kebira", Type: SpaceProperty, Group: GroupLightBlue,
	...
	b.Spaces[11] = Space{Index: 11, Name: "Av. Mohammed V", Type: SpaceProperty, Group: GroupPink,
		Price: 140, Rent: [6]int{10, 50, 150, 450, 625, 750}, HouseCost: 100}
	b.Spaces[12] = Space{Index: 12, Name: "ONEE (Electricite)", Type: SpaceUtility, Price: 150}
	b.Spaces[13] = Space{Index: 13, Name: "Rue des Consuls", Type: SpaceProperty, Group: GroupPink,
		Price: 140, Rent: [6]int{10, 50, 150, 450, 625, 750}, HouseCost: 100}
	b.Spaces[14] = Space{Index: 14, Name: "Kasbah Oudayas", Type: SpaceProperty, Group: GroupPink,
		Price: 160, Rent: [6]int{12, 60, 180, 500, 700, 900}, HouseCost: 100}
	b.Spaces[15] = Space{Index: 15, Name: "Gare Rabat-Ville", Type: SpaceRailroad, Price: 200}
	b.Spaces[16] = Space{Index: 16, Name: "Av. de la Liberte", Type: SpaceProperty, Group: GroupOrange,
	...
	b.Spaces[18] = Space{Index: 18, Name: "Rue de la Liberte", Type: SpaceProperty, Group: GroupOrange,
		Price: 180, Rent: [6]int{14, 70, 200, 550, 750, 950}, HouseCost: 100}
	b.Spaces[19] = Space{Index: 19, Name: "Grand Socco", Type: SpaceProperty, Group: GroupOrange,
	...
	b.Spaces[21] = Space{Index: 21, Name: "Jemaa el-Fna", Type: SpaceProperty, Group: GroupRed,
		Price: 220, Rent: [6]int{18, 90, 250, 700, 875, 1050}, HouseCost: 150}
	b.Spaces[22] = Space{Index: 22, Name: "Chance", Type: SpaceChance}
	b.Spaces[23] = Space{Index: 23, Name: "Rue Bab Agnaou", Type: SpaceProperty, Group: GroupRed,
		Price: 220, Rent: [6]int{18, 90, 250, 700, 875, 1050}, HouseCost: 150}
	b.Spaces[24] = Space{Index: 24, Name: "Koutoubia", Type: SpaceProperty, Group: GroupRed,
		Price: 240, Rent: [6]int{20, 100, 300, 750, 925, 1100}, HouseCost: 150}
	b.Spaces[25] = Space{Index: 25, Name: "Gare Marrakech", Type: SpaceRailroad, Price: 200}
	b.Spaces[26] = Space{Index: 26, Name: "Av. Mohammed VI", Type: SpaceProperty, Group: GroupYellow,
		Price: 260, Rent: [6]int{22, 110, 330, 800, 975, 1150}, HouseCost: 150}
	b.Spaces[27] = Space{Index: 27, Name: "Corniche Ain Diab", Type: SpaceProperty, Group: GroupYellow,
		Price: 260, Rent: [6]int{22, 110, 330, 800, 975, 1150}, HouseCost: 150}
	b.Spaces[28] = Space{Index: 28, Name: "LYDEC (Eau)", Type: SpaceUtility, Price: 150}
	b.Spaces[29] = Space{Index: 29, Name: "Bd. de la Corniche", Type: SpaceProperty, Group: GroupYellow,
	...
	b.Spaces[31] = Space{Index: 31, Name: "Vallee du Dades", Type: SpaceProperty, Group: GroupGreen,
		Price: 300, Rent: [6]int{26, 130, 390, 900, 1100, 1275}, HouseCost: 200}
	b.Spaces[32] = Space{Index: 32, Name: "Gorges du Todra", Type: SpaceProperty, Group: GroupGreen,
		Price: 300, Rent: [6]int{26, 130, 390, 900, 1100, 1275}, HouseCost: 200}
	b.Spaces[33] = Space{Index: 33, Name: "Caisse Commune", Type: SpaceCommunityChest}
	b.Spaces[34] = Space{Index: 34, Name: "Merzouga (Sahara)", Type: SpaceProperty, Group: GroupGreen,
		Price: 320, Rent: [6]int{28, 150, 450, 1000, 1200, 1400}, HouseCost: 200}
	b.Spaces[35] = Space{Index: 35, Name: "Gare Tanger-Ville", Type: SpaceRailroad, Price: 200}
	b.Spaces[36] = Space{Index: 36, Name: "Chance", Type: SpaceChance}
	b.Spaces[37] = Space{Index: 37, Name: "Chefchaouen", Type: SpaceProperty, Group: GroupDarkBlue,
		Price: 350, Rent: [6]int{35, 175, 500, 1100, 1300, 1500}, HouseCost: 200}
	b.Spaces[38] = Space{Index: 38, Name: "Taxe de Luxe", Type: SpaceTax, TaxAmount: config.LuxuryTax}
	b.Spaces[39] = Space{Index: 39, Name: "Mosquee Hassan II", Type: SpaceProperty, Group: GroupDarkBlue,
